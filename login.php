  ...
  <div class="container">
    ...
    <div class="forms">
          ...
          <form action="login_con.php" method="post">
            <div class="input-boxes">
              ...
              <div class="input-box">
                ...
                <input type="password" placeholder="Enter your password" required name="lpassword">
              </div>
      ...
      <div class="signup-form">
        ...
        <form action="register_con.php" method="post">
            <div class="input-boxes">
                <div class="input-box">
                    <i class="fas fa-user"></i>
                    <input type="text" placeholder="Enter your username" required name="name1">
                </div>
                <div class="input-box">
                    <i class="fas fa-envelope"></i>
