  ...
  <div class="page">
    ...
    <section class="breadcrumbs-custom-inset">
      <div class="breadcrumbs-custom context-dark bg-overlay-60">
        ...
        <div class="box-position" style="background-image: url(img/night.jpg);"></div>
      </div>
    </section>
    <!-- Why choose us-->
    <section class="section section-sm section-first bg-default text-md-left">
      <div class="container">
        <div class="row row-50 justify-content-center align-items-xl-center">
          <div class="col-md-10 col-lg-5 col-xl-6"><img src="img/rajchotu.png" alt="" width="519" height="564" />
          </div>
                ...
                <div class="tab-pane fade show active" id="tabs-4-1">
                  ...
                  <article class="progress-linear progress-secondary">
                    ...
                    <div class="progress-bar-linear-wrap">
                      <div class="progress-bar-linear" data-gradient=""><span class="progress-value">79</span><span
                  ...
                  <article class="progress-linear progress-orange">
                    ...
                    <div class="progress-bar-linear-wrap">
                      <div class="progress-bar-linear" data-gradient=""><span class="progress-value">72</span><span
                          class="progress-marker"></span></div>
                    </div>
                  </article>
                  <!-- Linear progress bar-->
                  <article class="progress-linear">
                    ...
                    <div class="progress-bar-linear-wrap">
                      <div class="progress-bar-linear" data-gradient=""><span class="progress-value">88</span><span
                          class="progress-marker"></span></div>
                    </div>
                  </article>
                </div>
                <div class="tab-pane fade" id="tabs-4-2">
                  <div class="row row-40 justify-content-center text-center inset-top-10">
                    ...
                    <div class="col-sm-4">
                      ...
                      <p class="progress-bar-circle-title">Consultancy</p>
                    </div>
                    <div class="col-sm-4">
                      <!-- Circle Progress Bar-->
                  ...
                  <div class="group-md group-middle"><a class="button button-width-xl-230 button-primary button-pipaluk"
                      href="contact.php">Get in touch</a><a class="button button-black-outline button-width-xl-230"
                      href="aboutt.php">Read more</a></div>
                </div>
                <div class="tab-pane fade" id="tabs-4-3">
                  <p>Orci nulla pellentesque dignissim enim sit. Elit ullamcorper dignissim cras tincidunt lobortis
                    feugiat vivamus. Nibh mauris cursus mattis molestie a iaculis at erat pellentesque.</p>
                  ...
                  <div class="group-md group-middle"><a class="button button-width-xl-230 button-primary button-pipaluk"
                      href="contact.php">Get in touch</a><a class="button button-black-outline button-md"
      ...
      <div class="owl-carousel owl-classic owl-timeline" data-items="1" data-md-items="2" data-lg-items="3"
        ...
        <div class="owl-item">
          ...
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"> <a href="package.php"><img src="img/pack1.png" alt="" width="420"
                height="308" /></a>
            </div>
          ...
          <div class="thumbnail-mary-description">
            <h5 class="thumbnail-mary-project"><a href="#">Blue City</a></h5><span class="thumbnail-mary-decor"></span>
        ...
        <div class="owl-item">
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"> <a href="package.php"><img src="img/pack2.png" alt="" width="420"
                height="308" /></a>
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
          ...
          <div class="thumbnail-mary-description">
            <h5 class="thumbnail-mary-project"><a href="#">Kumbhalgarh</a></h5><span class="thumbnail-mary-decor"></span>
            <h5 class="thumbnail-mary-time">
            </h5>
          </div>
        </div>
        <div class="owl-item">
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"> <a href="package.php"><img src="img/pack3.png" alt="" width="420"
                height="308" /></a>
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
          ...
          <div class="thumbnail-mary-description">
            <h5 class="thumbnail-mary-project"><a href="#">Pink City</a></h5><span
        ...
        <div class="owl-item">
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"> <a href="package.php"><img src="img/pack4.png" alt="" width="420"
                height="308" /></a>
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
          ...
          <div class="thumbnail-mary-description">
            <h5 class="thumbnail-mary-project"><a href="#">Mehrangarh</a></h5><span class="thumbnail-mary-decor"></span>
            <h5 class="thumbnail-mary-time">
            </h5>
          </div>
        </div>
        <div class="owl-item">
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"> <a href="package.php"><img src="img/pack5.png" alt="" width="420"
                height="308" /></a>
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
          ...
          <div class="thumbnail-mary-description">
            <h5 class="thumbnail-mary-project"><a href="#">Fateh Sagar</a></h5><span
              class="thumbnail-mary-decor"></span>
            <h5 class="thumbnail-mary-time">
            </h5>
          </div>
        ...
        <div class="owl-item">
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"> <a href="package.php"><img src="img/pack6.png" alt="" width="420"
                height="308" /></a>
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60"
          ...
          <div class="thumbnail-mary-description">
            <h5 class="thumbnail-mary-project"><a href="#">Sundarvan</a></h5><span class="thumbnail-mary-decor"></span>
            <h5 class="thumbnail-mary-time">
            </h5>
          </div>
        </div>
        ...
        <div class="owl-carousel owl-modern" data-items="1" data-stage-padding="15" data-margin="30" data-dots="true"
          ...
          <article class="quote-lisa">
            <div class="quote-lisa-body"><a class="quote-lisa-figure" href="#"><img class="img-circles"
                  src="images/face1.png" alt="" width="100" height="100" /></a>
              ...
              <h5 class="quote-lisa-cite"><a href="#">Rabindranath tagore</a></h5>
          ...
          <article class="quote-lisa">
            <div class="quote-lisa-body"><a class="quote-lisa-figure" href="#"><img class="img-circles"
                  src="images/face2.jpg" alt="" width="100" height="100" /></a>
              <div class="quote-lisa-text">
                <p class="q">Purai dhongsho!!!</p>
              </div>
              <h5 class="quote-lisa-cite"><a href="#">Asiful Haque</a></h5>
              <p class="quote-lisa-status">-</p>
            </div>
          </article>
          <!-- Quote Lisa-->
          <article class="quote-lisa">
            <div class="quote-lisa-body"><a class="quote-lisa-figure" href="#"><img class="img-circles"
                  src="images/face3.png" alt="" width="100" height="100" /></a>
              <div class="quote-lisa-text">
              ...
              <h5 class="quote-lisa-cite"><a href="#">Minhajur Rahman</a></h5>
              <p class="quote-lisa-status">Regular Client</p>
            </div>
          </article>
        </div>
    ...
    <section class="section section-fluid bg-default">
      <div class="parallax-container" data-parallax-img="img/pack5.png">
          ...
          <div class="row justfy-content-xl-space-berween row-10 align-items-md-center2">
            ...
            <div class="col-sm-6 col-md-4 order-sm-first">
              ...
              <p class="rights"><span>&copy;&nbsp;</span><span
                  class="copyright-year"></span><span>&nbsp;</span><span>Aibo</span>. All Rights Reserved. Design by
             vidhi </a></p>
            </div>
