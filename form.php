              ...
              <div class="rd-navbar-aside">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand">
                    <!--Brand--><a class="brand" href="index.php"><h1> Aibo </h1></a>
                  </div>
                </div>
...
$name = $email = $gender = $query = $website = "";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <br><br>
  <label for="spot">Choose your Spot:</label>
  <select id="spot" name="spot">
    <option value="Lahore">Lahore</option>
    <option value="Naran">Naran Kagan</option>
    <option value="Gilgit">Gilgit</option>
    <option value="audi">Skardu</option>
              ...
              <div class="col-sm-6 col-md-5 col-lg-3 col-xl-4">
                <div class="oh-desktop">
                  <div class="wow slideInDown" data-wow-delay="0s">
                    ...
                    <!-- Post Minimal 2-->
                    <article class="post post-minimal-2">
                      <p class="post-minimal-2-title"><a href="#">Top 10 Hotels: Rating by Aibo' Travel Experts</a></p>
                      <div class="post-minimal-2-time">
                        <time datetime="2021-05-04">May 04, 2021</time>
                      </div>
                    </article>
              ...
              <div class="col-sm-11 col-md-7 col-lg-5 col-xl-4">
                <div class="oh-desktop">
                  <div class="wow slideInLeft" data-wow-delay="0s">
                    ...
                    <div class="group-md group-middle justify-content-sm-start"><a class="button button-lg button-primary button-ujarak" href="contact.php">Get in touch</a></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="container">
            <div class="row justfy-content-xl-space-berween row-10 align-items-md-center2">
              ...
              <div class="col-sm-6 col-md-4 order-sm-first">
                <!-- Rights-->
                <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>Aibo</span>. All Rights Reserved. Design by NSTH</a></p>
              </div>
