...
<body>
  ...
  <div class="page">
    <!-- Page Header<a class="banner banner-top" href="#" target="_blank"><img src="images/intense_02.jpg" alt=""/></a>-->
    ...
    <section class="location">
      ...
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28895.096246227844!2d73.0417546787118!3d25.139509871058337!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3942eb582217cb0f%3A0x7fc249d94693a7df!2sSheoganj%2C%20Rajasthan!5e0!3m2!1sen!2sin!4v1675247863013!5m2!1sen!2sin"
          ...
          <div class="col-sm-8 col-md-6 col-lg-4">
            <article class="box-contacts">
              <div class="box-contacts-body">
                ...
                <p class="box-contacts-link"><a href="tel:#">+923111458029</a></p>
              </div>
            </article>
          </div>
          <div class="col-sm-8 col-md-6 col-lg-4">
            <article class="box-contacts">
              <div class="box-contacts-body">
                ...
                <div class="box-contacts-decor"></div>
                <p class="box-contacts-link"><a href="#">+923111458029</a></p>
              </div>
            </article>
          </div>
          <div class="col-sm-8 col-md-6 col-lg-4">
            <article class="box-contacts">
              <div class="box-contacts-body">
                ...
                <div class="box-contacts-decor"></div>
                <p class="box-contacts-link"><a href="mailto:#">aibo@gmail.com</a></p>
                <p class="box-contacts-link"><a href="mailto:#">info@aibo.org</a></p>
              </div>
            </article>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <form class="rd-form rd-form-variant-2 rd-mailform" data-form-output="form-output-global"
          ...
          <div class="row row-14 gutters-14">
            <div class="col-md-4">
              <div class="form-wrap">
                <input class="form-input" id="contact-your-name-2 name" type="text" name="name" data-constraints="@Required">
                <label class="form-label" for="contact-your-name-2">Your Name</label>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-wrap">
                <input class="form-input" id="contact-email-2 email" type="email" name="email"
            ...
            <div class="col-md-4">
              <div class="form-wrap">
                <input class="form-input" id="contact-phone-2 phone" type="text" name="phone" data-constraints="@Numeric">
            ...
            <div class="col-12">
              <div class="form-wrap">
                ...
                <textarea class="form-input textarea-lg" id="contact-message-2 message" name="message"
